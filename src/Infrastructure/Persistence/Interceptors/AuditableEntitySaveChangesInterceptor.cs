...
namespace Mechanic.Infrastructure.Persistence.Interceptors;
...
public class AuditableEntitySaveChangesInterceptor : SaveChangesInterceptor
{
    ...
    public void UpdateEntities(DbContext? context)
    {
        ...
        foreach (EntityEntry<IBaseAuditableEntity> entry in context.ChangeTracker.Entries<IBaseAuditableEntity>())
        {
